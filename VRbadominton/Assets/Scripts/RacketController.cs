...
public class RacketController : MonoBehaviour 
{
	...
	private GameObject rikishi001;
    private GameObject rikishi002;
	...
	void Start () 
	{
		...
		rikishi001 = GameObject.Find("Racket01");
        rikishi002 = GameObject.Find("Racket02");
	...
	void Update () 
	{
        ...
        matrixtotransform.SetTransformFromMatrix(rikishi001.transform, masic4);
        rikishi001.transform.position = sm0;
        ...
        matrixtotransform.SetTransformFromMatrix(rikishi002.transform, masic4);
        rikishi002.transform.position = sm3;
